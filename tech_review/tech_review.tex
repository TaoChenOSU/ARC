...
A couple of options to represente the location of the vehicle are x, y, \theta coordinate, 
...
density function by incoperating all available measurements. Using the log-odd operation 
...
input. Our system is a good example of a nonlinear system. The results are not propotional 
to any of the measurements and prior states.  
\item Particle Filter:\par
Particle filter usea sampling method to estimate the probability of states. It can keep 
