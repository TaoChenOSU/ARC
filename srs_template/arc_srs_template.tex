...
Vision processing, from either a stereoscopic or depth camera, will be interfaced through an i5 or better processor from an on board computer using 
A control board, specifically the PXSF on top of a Raspberry Pi or UP board, will be used 
as an interface between a computer that is doing high level computations, and the servos, 
motors, and other telemetry devices. 
...
\subsubsection{Memory constraints} %Tao 
...
%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Product Functions} %Tao, in progress
...
\subsubsection{Reliability} % Tao,in progress
