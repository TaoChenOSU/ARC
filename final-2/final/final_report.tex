...
We originally thought we would be implementing algoritms for probabilistic analysis of motion. 
...
Instead, we used a ROS package named teb_local_planner using an algorithm named "Time-Elastic-Band" utilizing a cost-map for path planning.\\
