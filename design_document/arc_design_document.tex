...
ARCS will be using a stereoscopic vision system to aid in navigation and obstacle avoidance. 
Vision systems are the "eyes" of the vehicle and are what allow the vehicle to operate autonomously. 
The vision system relates to requirements 
Using OpenCV, images will be taken in from two different USB cameras, hooked into the main computational unit, which will then match images based on time stamps. 
