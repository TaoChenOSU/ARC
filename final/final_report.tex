...
\begin{itemize}
    ...
    \begin{itemize}
      ...
      controller. So that's done. I have decided to use the teb_local_planner
      as our path planning package. I integrated it into the smart_driving
      ...
      Since the teb_local_planner also does obstacle avoidance, obstacle
...
\begin{itemize}
    ...
    \begin{itemize}
      ...
      It's simpler than Gazebo. We quickly got the teb_local_planning working
...
\begin{itemize}
    ...
    \begin{itemize}
      ...
      when something didn't work out. For example, we could've worked on the
