...
\subsubsection{System Feature: Image Analysis}
	...
	\paragraph{Functional requirement image analysis 1}
		\begin{enumerate}
			...
			\item Description: Image analysis needs to be computed quickly, at a rate of around 60+ fps.
...
\subsubsection{System Feature: Communications}
	...
	\paragraph{Functional Requirement Comms 2}
		\begin{enumerate}
			...
			\item Description: Control signals, such as "start", "stop", "go to way-point", etc. needs to be sent to the vehicle.
...
\begin{itemize}
	...
	\item The system is capable of drving the vehicle at maximum 10 miles per hour.
	\item The system is capable of navigating in an indoor environment of area no larger than 500 squre feet.
	\item The system is capable of navigating outdoor without space constraints.
	\item The system is capable of parallel parking in less than 5 maneuvers.
\end{itemize}
