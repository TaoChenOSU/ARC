...
%		\item[]{3.2.1.3.3 Functional requirement 5}~\\
		\begin{enumerate}
			\item ID: FR-NAV5
			\item Title: Global Path Planning Algorithm
...
%		\item[]{3.2.1.3.x Functional requirement 6}~\\
		...
		\begin{enumerate}
			\item ID: FR-NAV6
			\item Title: Local Path Planning Algorithm
...
%		\item[]{3.2.1.3.x Functional requirement 7}~\\
		...
		\begin{enumerate}
			\item ID: FR-NAV7
			\item Title: Obstacle Avoidance Algorithm
...
%		\item[]{3.2.1.3.x Functional requirement 8}~\\
		...
		\begin{enumerate}
			\item ID: FR-NAV8
			\item Title: Parallel Parking Algorithm
