...
\begin{figure}
  \centering
  \vspace{10cm}
  \includegraphics[width=\textwidth]{Block_Diagram.eps}
...
from the ARC system.
	...
	There should be a user interface (UI) for viewing a map of the surrounding
	area and the vehicle progress, as well as setting waypoints.
	There should be UI where all telemetry from the vehicle can
	be seen.
	\subsubsection{Hardware interfaces}
	There should be hardware interfaces for manual control of the vehicle. This
	interface should be able to override software control so that users can
	safely commandeer control of the vehicle from the autopilot. 

	\subsubsection{Software interfaces}
	There should be software interfaces between

	\subsubsection{Communications interfaces}


\subsection{System features}
Describes what can be expected for the ARC system to do in terms of its major features.
...
%		\item[]{3.2.1.3.4 Functional requirement 3}~\\
		\begin{enumerate}
			\item ID: FR-NAV3
...
%		\item[]{3.2.1.3.x Functional requirement 4}~\\
...
%		\item[]{3.2.1.3.3 Functional requirement 5}~\\
		\begin{enumerate}
			\item ID: FR-NAV5
...
%		\item[]{3.2.1.3.x Functional requirement 6}~\\
		%It should include both content and format as follows:
		\begin{enumerate}
			\item ID: FR-NAV6
...
%		\item[]{3.2.1.3.x Functional requirement 7}~\\
		%It should include both content and format as follows:
		\begin{enumerate}
			\item ID: FR-NAV7
...
%		\item[]{3.2.1.3.x Functional requirement 8}~\\
		%It should include both content and format as follows:
		\begin{enumerate}
			\item ID: FR-NAV8
...
\subsubsection{System Feature: Hardware mounting}
	\begin{itemize}
		\item[]{3.2.1.3.x Functional requirement 1}~\\
		%It should include both content and format as follows:
		\begin{enumerate}
			\item ID: FR-HW1
		...
		\item[]{3.2.1.3.x Functional requirement 2}~\\
		\begin{enumerate}
			\item ID: FR-HW2
...
\subsubsection{System Feature: Control System}
\subsubsection{System Feature: Path Planning}
\subsubsection{System Feature: Obstacle Avoidance}
\subsubsection{System Feature: Parallel Park}
