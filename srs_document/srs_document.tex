...
\subsubsection{System Feature: User Interface}
	...
	\paragraph{Functional Reqirement User Interface 1}
		\begin{enumerate}
			\item ID: FR-UI2
			...
			\item Completion Metric: Sensor and vehicle data are displayed through a GUI on the ground station.
		\end{enumerate}

	\paragraph{Functional Reqirement User Interface 3}
		\begin{enumerate}
			\item ID: FR-UI3
	...
	\paragraph{Functional Reqirement User Interface 4}
		\begin{enumerate}
			\item ID: FR-UI4
	...
	\paragraph{Functional Reqirement User Interface 5}
		\begin{enumerate}
			\item ID: FR-UI5
...
There will be no redundant software systems. Any unrecoverable system errors will put the vehicle  direct user/manual control.
