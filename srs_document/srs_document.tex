...
and a release plan based on the requirments.~\cite{IEEE830}
...
\subsection{System features}
	\subsubsection{System Feature 1}
		\myparagraph{Introduction/Purpose of feature}
		Does this work?
		\paragraph{Stimulus/Response sequence}
		\myparagraph{Associated functional requirements}


%		\begin{enumerate}
%			\item[Introduction/Purpose of feature]
%			\item[Stimulus/Response sequence]
%			\item[Associated functional requirements]
%			\begin{enumerate}
%				\item[Functional requirement 1]
%				\item[Functional requirement 2]
%				\item[Functional requirement n]
%			\end{enumerate}
%		\end{enumerate}
